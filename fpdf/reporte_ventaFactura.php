...
function Header()
{
  ...
  $this->Cell(89, 8, 'REPORTE DE Ventas',0,1);
  $this->SetY(65);
  $this->SetX(100);
...
$consulta ="SELECT v.id_venta,p.nombreproducto,p.descripcion,p.costoventa,dv.cantidad,dv.costo,v.fecha,cl.razonsocial,e.nombre,e.paterno from venta v 
...
$pdf->Cell(30, 12, utf8_decode('razonsocial'),1,0,'C',1);
$pdf->Cell(80, 12, utf8_decode('cantidad'),1,0,'C',1);
$pdf->Cell(15, 12, utf8_decode('nombreproducto'),1,0,'C',1);
$pdf->Cell(15, 12, utf8_decode('costo'),1,0,'C',1);
...
$pdf->Cell(30, 17, utf8_decode($value['razonsocial']),'B',0,'C',1);
$pdf->Cell(20, 17, utf8_decode($value['cantidad']),'B',0,'C',1);
$pdf->Cell(35, 17, utf8_decode($value['nombreproducto']),'B',0,'C',1);
$pdf->Cell(20, 17, utf8_decode($value['costo']),'B',0,'C',1);
