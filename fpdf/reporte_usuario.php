...
function Header()
{
  ...
  $this->Cell(89, 8, 'REPORTE DE USUARIOS ACTIVOS',0,1);
  $this->SetY(65);
  $this->SetX(100);
...
function Footer()
{
     $this->SetFont('helvetica', 'B', 8);
        ...
        $this->Cell(0,5,utf8_decode("GRUPO "),0,0,"C");
...
$pdf->Cell(20, 8, utf8_decode($key+1),'B',0,'C',1);
//$pdf->Cell(70, 8, utf8_decode($value['id_usuario']),'B',0,'L',1);
$pdf->Cell(30, 8, utf8_decode($value['usuario']),'B',0,'C',1);
$pdf->Cell(10, 8, utf8_decode('****'),'B',0,'C',1);
$pdf->Cell(25, 8, utf8_decode($value['nivel']),'B',0,'C',1);
$pdf->Cell(15, 8, utf8_decode($value['estado']),'B',1,'C',1);
$pdf->Ln(0.5);
