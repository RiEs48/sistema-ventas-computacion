...
$pdf->Cell(30, 12, utf8_decode('Razon Social'),0,0,'C',1);
$pdf->Cell(80, 12, utf8_decode('nit ci'),0,0,'C',1);
...
$pdf->Cell(10, 8, utf8_decode($key+1),'B',0,'C',1);
$pdf->Cell(30, 8, utf8_decode($row['razonsocial']),'B',0,'C',1);
$pdf->Cell(80, 8, utf8_decode($row['nit_ci']),'B',1,'C',1);
