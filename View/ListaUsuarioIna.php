...
<table class="table table-striped table-hover">
    ...
    <tbody>
        ...
        ?>
            ...
            <td><a href='../Controller/usuarioActivar.php?cid=<?php echo $reg[0]; ?>' class="btn btn-success"><i class="far fa-edit"></i></a></td>
            <td><a href='../Controller/eliminaUsuarioIna.php?cid=<?php echo $reg[0]; ?>' class="btn btn-danger"><i class="far fa-trash-alt"></i></a></td>
